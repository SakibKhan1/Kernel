...
//The operation replaces pixel e 
//(in the middle of the 3x3 window) 
//with some function of its neighbors 
//f(a,b,c,d,e,f,g,h,i). It is possible to implement blur,
// edge detection, and many other image processing operations using this technique.
#include <iostream>
#include <cassert>
#include <cstdlib>
#include <fstream>
